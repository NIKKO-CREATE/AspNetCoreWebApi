...
namespace SmartSchool.API.Data
{
    public class SmartContext : DbContext
    {
        ...
        public System.Data.Entity.DbSet<Aluno> Alunos { get; set; }
        public System.Data.Entity.DbSet<Professor> Professores { get; set; }
        public System.Data.Entity.DbSet<Disciplina> Disciplinas { get; set; }
        public System.Data.Entity.DbSet<AlunoDisciplina> AlunosDisciplinas { get; set; }

        // Método herdado do DbContext feito para inserir 
        protected override void OnModelCreating(ModelBuilder builder)
        {
            builder.Entity<AlunoDisciplina>().HasKey(AD => new { AD.AlunoId, AD.DisciplinaId }); // Inserido chave primária no AlunoDisciplina
