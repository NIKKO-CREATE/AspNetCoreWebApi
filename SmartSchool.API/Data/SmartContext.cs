        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            _ = builder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    ...
                    new Aluno(8, 8, "Sandro", "Gonçalves", "9874512", DateTime.Parse("1999/03/15")),
                    new Aluno(9, 9, "Patricia", "Barcellos", "9874512", DateTime.Parse("1976/07/07"))
                });

            _ = builder.Entity<AlunoDisciplina>()
